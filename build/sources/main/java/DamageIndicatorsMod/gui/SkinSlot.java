...
public class SkinSlot {
    ...
    protected void drawSlot(int par1, int par2, int par3, int par4) {
        String text1 = AbstractSkin.getSkinName((String)AbstractSkin.AVAILABLESKINS.get(par1));
    ...
    public void drawScreen(int mouseX, int mouseY, float par3) {
        try {
            ...
            addVertexWithUV((double)this.left, (double)this.bottom, (double)0.0F, (double)0.0F, (double)1.0F);
            addVertexWithUV((double)this.right, (double)this.bottom, (double)0.0F, (double)1.0F, (double)1.0F);
            addVertexWithUV((double)this.right, (double)this.top, (double)0.0F, (double)1.0F, (double)0.0F);
            addVertexWithUV((double)this.left, (double)this.top, (double)0.0F, (double)0.0F, (double)0.0F);
            GL11.glEnd();
            GL11.glEnable(3553);
            ...
            for(int var11 = 0; var11 < ex; ++var11) {
                ...
                if (var19 <= this.bottom && var19 + var13 >= this.top) {
                    if (this.showSelectionBox && this.isSelected(var11)) {
                        ...
                        float k = 128.0F;
                        float l = 128.0F;
                        j = (float)((double)j / (double)255.0F);
                        k = (float)((double)k / (double)255.0F);
                        l = (float)((double)l / (double)255.0F);
                        GL11.glColor3f(j, k, l);
                        addVertexWithUV((double)boxLeft, (double)(var19 + var13 + 2), (double)0.0F, (double)0.0F, (double)1.0F);
                        addVertexWithUV((double)boxRight, (double)(var19 + var13 + 2), (double)0.0F, (double)1.0F, (double)1.0F);
                        addVertexWithUV((double)boxRight, (double)(var19 - 2), (double)0.0F, (double)1.0F, (double)0.0F);
                        addVertexWithUV((double)boxLeft, (double)(var19 - 2), (double)0.0F, (double)0.0F, (double)0.0F);
                        GL11.glColor3f(0.0F, 0.0F, 0.0F);
                        addVertexWithUV((double)(boxLeft + 1), (double)(var19 + var13 + 1), (double)0.0F, (double)0.0F, (double)1.0F);
                        addVertexWithUV((double)(boxRight - 1), (double)(var19 + var13 + 1), (double)0.0F, (double)1.0F, (double)1.0F);
                        addVertexWithUV((double)(boxRight - 1), (double)(var19 - 1), (double)0.0F, (double)1.0F, (double)0.0F);
                        addVertexWithUV((double)(boxLeft + 1), (double)(var19 - 1), (double)0.0F, (double)0.0F, (double)0.0F);
                        GL11.glEnd();
                        GL11.glEnable(3553);
                    }
            ...
            GL11.glBegin(7);
            GL11.glColor3f(0.0F, 0.0F, 0.0F);
            addVertexWithUV((double)this.left, (double)(this.top + var20), (double)0.0F, (double)0.0F, (double)1.0F);
            addVertexWithUV((double)this.right, (double)(this.top + var20), (double)0.0F, (double)1.0F, (double)1.0F);
            ...
            addVertexWithUV((double)this.right, (double)this.bottom, (double)0.0F, (double)1.0F, (double)1.0F);
            GL11.glColor3f(0.0F, 0.0F, 0.0F);
            addVertexWithUV((double)this.right, (double)(this.bottom - var20), (double)0.0F, (double)1.0F, (double)0.0F);
            addVertexWithUV((double)this.left, (double)(this.bottom - var20), (double)0.0F, (double)0.0F, (double)0.0F);
            GL11.glEnd();
            int var19 = this.getContentHeight() - (this.bottom - this.top - 4);
            if (var19 > 0) {
                ...
                GL11.glBegin(7);
                GL11.glColor3f(0.0F, 0.0F, 0.0F);
                addVertexWithUV((double)scrollBarXStart, (double)this.bottom, (double)0.0F, (double)0.0F, (double)1.0F);
                addVertexWithUV((double)scrollBarXEnd, (double)this.bottom, (double)0.0F, (double)1.0F, (double)1.0F);
                addVertexWithUV((double)scrollBarXEnd, (double)this.top, (double)0.0F, (double)1.0F, (double)0.0F);
                addVertexWithUV((double)scrollBarXStart, (double)this.top, (double)0.0F, (double)0.0F, (double)0.0F);
                GL11.glEnd();
                GL11.glBegin(7);
                float j = 128.0F;
                float k = 128.0F;
                ...
                l = (float)((double)l / (double)255.0F);
                GL11.glColor3f(j, k, l);
                addVertexWithUV((double)scrollBarXStart, (double)(var14 + var13), (double)0.0F, (double)0.0F, (double)1.0F);
                addVertexWithUV((double)scrollBarXEnd, (double)(var14 + var13), (double)0.0F, (double)1.0F, (double)1.0F);
                addVertexWithUV((double)scrollBarXEnd, (double)var14, (double)0.0F, (double)1.0F, (double)0.0F);
                addVertexWithUV((double)scrollBarXStart, (double)var14, (double)0.0F, (double)0.0F, (double)0.0F);
                GL11.glEnd();
                GL11.glBegin(7);
                j = 192.0F;
                k = 192.0F;
                ...
                l = (float)((double)l / (double)255.0F);
                GL11.glColor3f(j, k, l);
                addVertexWithUV((double)scrollBarXStart, (double)(var14 + var13 - 1), (double)0.0F, (double)0.0F, (double)1.0F);
                addVertexWithUV((double)(scrollBarXEnd - 1), (double)(var14 + var13 - 1), (double)0.0F, (double)1.0F, (double)1.0F);
                addVertexWithUV((double)(scrollBarXEnd - 1), (double)var14, (double)0.0F, (double)1.0F, (double)0.0F);
                addVertexWithUV((double)scrollBarXStart, (double)var14, (double)0.0F, (double)0.0F, (double)0.0F);
                GL11.glEnd();
            }
