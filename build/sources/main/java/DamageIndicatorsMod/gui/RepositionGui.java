...
public class RepositionGui extends GuiScreen {
    ...
    private void drawColorSelector() {
        ...
        GL11.glVertex3d((double)0.0F, (double)0.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)0.0F, (double)1.0F);
        GL11.glVertex3d((double)0.0F, (double)64.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)1.0F, (double)1.0F);
        GL11.glVertex3d((double)64.0F, (double)64.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)1.0F, (double)0.0F);
        GL11.glVertex3d((double)64.0F, (double)0.0F, (double)this.zLevel);
        GL11.glEnd();
        this.colorBarTex.updateDynamicTexture();
        GL11.glBegin(7);
        GL11.glTexCoord2d((double)0.0F, (double)0.0F);
        GL11.glVertex3d((double)66.0F, (double)0.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)0.0F, (double)1.0F);
        GL11.glVertex3d((double)66.0F, (double)64.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)1.0F, (double)1.0F);
        GL11.glVertex3d((double)70.0F, (double)64.0F, (double)this.zLevel);
        GL11.glTexCoord2d((double)1.0F, (double)0.0F);
        GL11.glVertex3d((double)70.0F, (double)0.0F, (double)this.zLevel);
        GL11.glEnd();
    }
