...
public class AdvancedGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.fontRenderer.drawStringWithShadow(((EntityConfigurationEntry)GuiEntityList.entities.get(this.selectedEntry)).Clazz.getName(), 225.0F, 160.0F, 10066431);
    ...
    public void createTooltips() {
        ...
        this.controlLocations.add(new Rectangle(225, 160, this.fontRenderer.getStringWidth(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(this.selectedEntry)).Clazz.getName()), this.fontRenderer.FONT_HEIGHT));
        this.controlTooltipText.add(new String[]{"Full Class Path For Debugging."});
        ...
        for(int i = 0; i < this.controlLocations.size(); ++i) {
            this.controlTooltipText.set(i, (String[])this.fontRenderer.listFormattedStringToWidth(((String[])this.controlTooltipText.get(i))[0], this.tooltipWidth - 2).toArray());
        }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (this.entrySelected) {
            ...
            this.fontRenderer.drawStringWithShadow(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(this.selectedEntry)).Clazz.getName(), 225.0F, 160.0F, 10066431);
            ...
            try {
                ...
                this.tempMob.renderYawOffset = (float)Math.atan((double)(headPosX / 40.0F)) * 20.0F + 35.0F;
                this.tempMob.rotationYaw = (float)Math.atan((double)(headPosX / 40.0F)) * 40.0F;
                this.tempMob.rotationPitch = (float)Math.atan((double)(headPosY / 40.0F)) * 20.0F;
                ...
                DIGuiTools.DrawPortraitSkinned(150, 175, var14, (int)Math.ceil(this.tempMob == null ? (double)0.0F : (double)this.tempMob.getHealth()), (int)Math.ceil(this.tempMob == null ? (double)0.0F : (double)this.tempMob.getMaxHealth()), this.tempMob);
                    ...
                    for(int lines = 0; lines < this.controlLocations.size(); ++lines) {
                        try {
                            if (((Rectangle)this.controlLocations.get(lines)).contains(par1, par2)) {
                                ...
                                this.tooltip.HEIGHT = ((String[])this.controlTooltipText.get(lines)).length * (this.fontRenderer.FONT_HEIGHT + 2) + 6;
    ...
    protected void actionPerformed(GuiButton par1GuiButton) throws IOException {
        ...
        EntityConfigurationEntry newEce1 = new EntityConfigurationEntry(current.Clazz, Float.valueOf(((GuiTextField)this.textboxes.get(0)).getText()), Float.valueOf(((GuiTextField)this.textboxes.get(1)).getText()), Float.valueOf(((GuiTextField)this.textboxes.get(2)).getText()), Float.valueOf(((GuiTextField)this.textboxes.get(3)).getText()), Float.valueOf(((GuiTextField)this.textboxes.get(4)).getText()), ((GuiCheckBox)this.buttonList.get(1)).isChecked(), ((GuiTextField)this.textboxes.get(5)).getText(), ((GuiCheckBox)this.buttonList.get(0)).isChecked(), current.maxHP, current.eyeHeight, ((GuiCheckBox)this.buttonList.get(3)).isChecked());
    ...
    public void listClickedCallback(int index) {
        ...
        ((GuiCheckBox)this.buttonList.get(0)).setChecked(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(index)).IgnoreThisMob);
        ...
        ((GuiCheckBox)this.buttonList.get(1)).setChecked(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(index)).AppendBaby);
        ...
        ((GuiCheckBox)this.buttonList.get(3)).setChecked(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(index)).DisableMob);
    ...
    public void addTextBoxes(int listIndex) {
        ...
        ((GuiTextField)this.textboxes.get(0)).setText(String.valueOf(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(listIndex)).ScaleFactor));
        this.textboxes.add(1, new GuiTextField(1, this.fontRenderer, 225, 46, 120, 10));
        ((GuiTextField)this.textboxes.get(1)).setText(String.valueOf(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(listIndex)).XOffset));
        this.textboxes.add(2, new GuiTextField(2, this.fontRenderer, 225, 62, 120, 10));
        ((GuiTextField)this.textboxes.get(2)).setText(String.valueOf(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(listIndex)).YOffset));
        this.textboxes.add(3, new GuiTextField(3, this.fontRenderer, 225, 78, 120, 10));
        ((GuiTextField)this.textboxes.get(3)).setText(String.valueOf(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(listIndex)).EntitySizeScaling));
        this.textboxes.add(4, new GuiTextField(4, this.fontRenderer, 225, 110, 120, 10));
        ((GuiTextField)this.textboxes.get(4)).setText(String.valueOf(((EntityConfigurationEntry)this.guiEntityList.visibleEntities.get(listIndex)).BabyScaleFactor));
